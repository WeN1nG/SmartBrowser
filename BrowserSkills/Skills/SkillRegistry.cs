namespace BrowserSkills.Skills;
...
public class SkillRegistry
{
    ...
    private readonly Dictionary<string, Strategy.IStrategyHandler> _strategyHandlers = new();
    ...
    public void RegisterStrategyHandler(string strategyId, Strategy.IStrategyHandler handler)
    {
    ...
    public Strategy.IStrategyHandler? GetStrategyHandler(string strategyId)
    {
