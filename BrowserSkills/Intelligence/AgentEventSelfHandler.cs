...
/// <summary>
/// Agent 自检测器 —— 在工具循环中实时检测死胡同并自动干预。
/// 检测项：过期元素复用、重复导航失败、相同动作重复、无进展循环、ask_user 推荐忽略。
/// </summary>
...
/// Agent 自检测决策结果。
/// </summary>
public sealed record ToolSelfHandlingDecision(bool ShouldExecute, string? SyntheticToolResult)
{
